...
const lessonDetails = {
  beginner: [
    'Proper drum kit setup and seating posture',
    'Basic grip techniques (matched & traditional)',
    'Understanding rhythm and counting',
    'Essential rudiments (single/double stroke, paradiddles)',
    'Simple grooves in rock, pop and funk styles'
  ],
  intermediate: [
    'Advanced rudiments and stick control',
    'Complex coordination (limb independence)',
    'Syncopated grooves and fills',
    'Styles: jazz, latin, funk, rock, hip-hop',
    'Dynamics, ghost notes & groove variations'
  ],
  advanced: [
    'Advanced linear playing & polyrhythms',
    'Contemporary styles & fusion grooves',
    'Soloing concepts and phrasing',
    'Odd time signatures and metric modulation',
    'Professional performance & recording preparation'
  ]
}

const instructorHighlights = [
  'Experienced drummers with live & studio background',
  'Learn multiple styles: rock, jazz, funk, latin & more',
  'Strong focus on solid time & groove from day one',
  'Regular jam sessions and performance opportunities',
  'Preparation for band playing and studio recording'
]

export default function DrumsetLessonsPage() {
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-6xl font-bold font-display text-white mb-6">
                Drumset <span className="text-coral-500">Lessons</span>
              </h1>
              <p className="text-xl text-charcoal-300 mb-8">
                Master the drums with expert guidance. Build rock-solid time, develop killer grooves, 
                and express yourself across any musical style on the most powerful instrument in the band.
              </p>
            ...
            <div className="relative h-[400px] rounded-2xl overflow-hidden">
              <Image
                src="/images/instruments/Drumset.jpg"
                alt="Drumset lessons"
                fill
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-3 mb-6">
                  ...
                  <li className="flex items-center gap-3">
                    <CheckCircle className="w-5 h-5 text-green-500 shrink-0" />
                    <span className="text-charcoal-600">Social & band experience</span>
                  </li>
                </ul>
                <Link href="/register">
      ...
      <section className="py-20 bg-coral-500">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          ...
          <p className="text-white/80 mb-8 max-w-2xl mx-auto">
            Book your first lesson today and feel the power of driving the rhythm with confidence.
          </p>
          <Link href="/register">
