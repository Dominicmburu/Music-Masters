...
const lessonDetails = {
  beginner: [
    'Understanding keyboard layout and functions',
    'Basic chord progressions and melodies',
    'Introduction to synthesizer sounds',
  ...
  intermediate: [
    ...
    'Layering and arranging techniques',
    'Performance with backing tracks'
  ],
  advanced: [
    'Professional music production',
    'Advanced synthesis and sound manipulation',
    'Live performance setup and techniques',
    'Composing for electronic music',
    'Studio recording and mixing'
  ]
}

const instructorHighlights = [
  'Learn modern electronic keyboard and synthesizers',
  'Access to professional digital keyboards',
  'Integration with music production software',
  'Contemporary and classical repertoire',
  'Prepare for live performances and recording'
]
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-6xl font-bold font-display text-white mb-6">
                Keyboard <span className="text-coral-500">Lessons</span>
              </h1>
              <p className="text-xl text-charcoal-300 mb-8">
                Master electronic keyboards and synthesizers with expert instruction. Learn modern 
                techniques for contemporary music production and performance.
              </p>
            ...
            <div className="relative h-[400px] rounded-2xl overflow-hidden">
              <Image
                src="/images/instruments/Keyboard.jpg"
                alt="Keyboard lessons"
                fill
      ...
      <section className="py-20 bg-coral-500">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold font-display text-white mb-6">
            Ready to Start Your Keyboard Journey?
          </h2>
          <p className="text-white/80 mb-8 max-w-2xl mx-auto">
            Book your first lesson today and discover the joy of playing keyboard with expert guidance.
          </p>
          <Link href="/register">
