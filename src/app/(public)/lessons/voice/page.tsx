...
const lessonDetails = {
  beginner: [
    'Proper posture and breathing fundamentals',
    'Vocal warm-ups and basic range discovery',
    'Pitch matching and ear training basics',
    'Healthy vocal production & placement',
    'Simple songs and melody singing'
  ],
  intermediate: [
    'Breath control & diaphragmatic support',
    'Vocal registers (chest, head, mix voice)',
    'Vibrato development and control',
    'Dynamics, phrasing & musical expression',
    'Popular & classical repertoire building'
  ],
  advanced: [
    'Advanced vocal technique & agility',
    'Belting, runs, riffs and stylistic ornamentation',
    'Vocal health & stamina for long performances',
    'Performance coaching & stage presence',
    'Audition preparation & recording techniques'
  ]
}

const instructorHighlights = [
  'Experienced vocal coaches with professional performance background',
  'Focus on healthy technique from the very first lesson',
  'Develop your unique voice across multiple styles',
  'Regular performance opportunities & recitals',
  'Preparation for recording, live shows & auditions'
]

export default function VocalsLessonsPage() {
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-6xl font-bold font-display text-white mb-6">
                Vocals <span className="text-coral-500">Lessons</span>
              </h1>
              <p className="text-xl text-charcoal-300 mb-8">
                Unlock your true voice with expert vocal training. Build confidence, expand your range, 
                and sing with power, control, and authentic emotion — safely and sustainably.
              </p>
            ...
            <div className="relative h-[400px] rounded-2xl overflow-hidden">
              <Image
                src="/images/instruments/Vocals.jpg"
                alt="Vocals lessons"
                fill
