...
const lessonDetails = {
  beginner: [
    'Proper violin holding and bow technique',
    'Basic finger placement and posture',
    'Reading music notation for strings',
    'Simple scales and etudes',
  ...
  intermediate: [
    ...
    'Position changes and shifting',
    'Ensemble and orchestral playing'
  ],
  advanced: [
    'Virtuoso techniques and advanced repertoire',
    'Romantic and contemporary works',
    'Solo performance preparation',
    'Advanced interpretation and musicality',
    'Audition and competition preparation'
  ]
}

const instructorHighlights = [
  'Experienced violinists trained in classical tradition',
  'Learn classical violin and fiddle styles',
  'Proper technique from the very beginning',
  'Regular recitals and performance opportunities',
  'Preparation for orchestra and ensemble playing'
]
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-6xl font-bold font-display text-white mb-6">
                Violin <span className="text-coral-500">Lessons</span>
              </h1>
              <p className="text-xl text-charcoal-300 mb-8">
                Master the violin with expert instruction. Learn classical technique, expressive 
                playing, and develop your unique musical voice on this beautiful instrument.
              </p>
      ...
      <section className="py-20 bg-coral-500">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          ...
          <p className="text-white/80 mb-8 max-w-2xl mx-auto">
            Book your first lesson today and discover the joy of playing violin with expert guidance.
          </p>
          <Link href="/register">
